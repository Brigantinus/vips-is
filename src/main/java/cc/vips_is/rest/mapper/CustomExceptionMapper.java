...
public class CustomExceptionMapper {
    ...
    @Provider
    public static class ImageNotFoundExceptionMapper implements ExceptionMapper<ImageNotFoundException> {
    ...
    @Provider
    public static class InvalidParameterExceptionMapper implements ExceptionMapper<InvalidParameterException> {
        @Context UriInfo uriInfo;
        @Override
    ...
    @Provider
    public static class StorageExceptionMapper implements ExceptionMapper<StorageException> {
        @Context UriInfo uriInfo;
        @Override
    ...
    @Provider
    public static class ProcessingExceptionMapper implements ExceptionMapper<ImageProcessingException> {
        @Context UriInfo uriInfo;
        @Override
